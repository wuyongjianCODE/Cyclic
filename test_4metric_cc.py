...
def print_ALL_with_metreics_copmparasion():
    ...
    for filename in os.listdir(submittwo[0]):
        ...
        #
        #           ]
        if f_ajis[0]>0.2 and f_ajis[1]>0.2 and f_ajis[2]>0.2 :#and filename in set(allpic):#f_dices[1]>0.6 and f_dices[2]>0.6 and f_dices[0]>0.6 :
