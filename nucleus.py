...
def get_globaldatdaset():
    return globaldataset
def set_VAL_IMAGE_IDS(dataset_name=globaldataset):
    VAL_IMAGE_IDS_=[]
    if dataset_name=="nucleus":
        VAL_IMAGE_IDS_ = [
            "1_Region 1",
            "108_Region 5",
            "3_Region 10",
...
class NucleusDataset(utils.Dataset):
    ...
    def load_nucleus(self, dataset_dir, subset):
        ...
        self.add_class(get_globaldatdaset(), 1, get_globaldatdaset())
    ...
    def image_reference(self, image_id):
        ...
        info = self.image_info[image_id]
        if info["source"] == get_globaldatdaset():
            return info["id"]
        else:
...
if __name__ == '__main__':
    ...
    try:
        (datasetpath, tempfilename) = os.path.split(args.dataset)
        globaldataset = tempfilename
    except:
        pass
    VAL_IMAGE_IDS = set_VAL_IMAGE_IDS(globaldataset)
    if args.subset:
